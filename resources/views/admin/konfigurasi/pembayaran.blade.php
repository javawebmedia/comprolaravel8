...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <img src="{{ asset('assets/upload/image/'.$site->gambar_pembayaran) }}" class="img img-thumbnail img-fluid">
        </div>
    </div>
    ...
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <textarea name="isi_pembayaran" class="form-control" id="kontenku"><?php echo $site->isi_pembayaran ?></textarea>
        </div>
